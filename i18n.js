...
(function () {
  ...
  var DICT = {
    ...
    "Връзката с каталога е временно недостъпна.": "The inventory connection is temporarily unavailable.",
    "Моля, опитайте отново след малко.": "Please try again in a moment.",
    "Опитай отново": "Try again",
    "Зареждане на автомобила…": "Loading vehicle…",
  ...
  /* Verified inventory terms. */
  Object.assign(DICT, {"Пълна сервизна история!":"Full service history","Пълна сервизна история":"Full service history","Възможен лизинг!":"Possible lease","Възможен лизинг":"Leasing available","Възможен бартер!":"Possible barter","Възможен бартер":"Part exchange available","Черен металик":"Black metallic","Автомобилът е цялостно фолиран с предпазно фолио черен мат!":"The car is completely foiled with matte black protective foil!","Автомобилът е цялостно фолиран с предпазно фолио черен мат":"The car is completely foiled with matte black protective foil","Автомобил с 6+1 места":"Car with 6+1 seats","Черен":"Black","Цена без начислен 20% ДДС!":"Price excluding 20% ​​VAT","Цена без начислен 20% ДДС":"Price excluding 20% ​​VAT","Сив металик":"Gray metallic","Бял металик":"White metallic","Автомобилът е цялостно облепен в предпазно фолио с матиращ ефект!":"The car is completely wrapped in a protective film with a matting effect!","Автомобилът е цялостно облепен в предпазно фолио с матиращ ефект":"The car is completely wrapped in a protective film with a matting effect","Сив":"Grey","Тъмно зелен металик":"Dark green metallic","Фабрично нов автомобил!":"Brand new car!","Фабрично нов автомобил":"Brand new car","Удължена фабрична гаранция до 5 години от първа регистрация или 200 000 км.!":"Extended factory warranty up to 5 years from first registration or 200,000 km.!","Удължена фабрична гаранция до 5 години от първа регистрация или 200 000 км":"Extended factory warranty up to 5 years from first registration or 200,000 km","Удължена фабрична гаранция до 01.2031 г. или 200 000 км.":"Extended factory warranty until 01.2031 or 200,000 km.","Удължена фабрична гаранция до 01.2031 г. или 200 000 км":"Extended factory warranty until 01.2031 or 200,000 km","Автомобиълт е облепен с безцветно предпазно фолио!":"A car is covered with a colorless protective film!","Автомобиълт е облепен с безцветно предпазно фолио":"A car is covered with a colorless protective film","Син мат":"Matte blue","Бял":"White","Тъмно сив металик":"Dark gray metallic","Зелен металик":"Green metallic","Син металик":"Blue metallic","Тъмно син металик":"Dark blue metallic","Автомобил с удължено междуосие Long Wheelbase (LWB)":"Long Wheelbase (LWB) vehicle","Тъмно кафяв металик":"Dark brown metallic","Удължена фабрична гаранция до 03.2027 г. или 200 000 км.!":"Extended factory warranty until 03.2027 or 200,000 km!","Удължена фабрична гаранция до 03.2027 г. или 200 000 км":"Extended factory warranty until 03.2027 or 200,000 km","Сив мат":"Matte grey","Светло кафяв металик":"Light brown metallic","Червен металик":"Red metallic","Автомобилът е цялостно фолиран в сив мат.":"The car is completely foiled in gray mat.","Автомобилът е цялостно фолиран в сив мат":"The car is completely foiled in gray mat","Черен / Сив мат":"Black / Gray matt","Фабрична гаранция до 07.2026 г. или 200 000 км.!":"Factory warranty until 07.2026 or 200,000 km!","Фабрична гаранция до 07.2026 г. или 200 000 км":"Factory warranty until 07.2026 or 200,000 km","Сребърен металик":"Silver metallic","Син":"Blue","Сертификат N1 за товарен автомобил!":"N1 certificate for a truck!","Сертификат N1 за товарен автомобил":"N1 certificate for a truck","Добавен екстериорен пакет от G63 AMG!":"G63 AMG Exterior Package Added!","Добавен екстериорен пакет от G63 AMG":"G63 AMG Exterior Package Added","Добавена е спортна изпускателна система MILLTEK Sport!":"Added MILLTEK Sport Exhaust System!","Добавена е спортна изпускателна система MILLTEK Sport":"Added MILLTEK Sport Exhaust System","Автомобилът е с електроника и компоненти за повишаване на мощността до 800 к.с.!":"The car has electronics and components to increase the power to 800 hp!","Автомобилът е с електроника и компоненти за повишаване на мощността до 800 к.с":"The car has electronics and components to increase the power to 800 hp","Автомобилът е облепен с безцветно предпазно фолио":"The car is wrapped in clear protective film"});
  ...
  function setLang(next) {
    ...
    if (!wipe || reduce || matchMedia("(hover: none), (pointer: coarse)").matches) { commit(next); return; }
    swapping = true;
