/* AutoHaus geometric desktop gallery enhancement. Loaded only on vehicle pages. */
(function () {
  "use strict";
  if (typeof document === "undefined" || document.getElementById("ah-geometric-gallery-v2")) return;
  var style = document.createElement("style");
  style.id = "ah-geometric-gallery-v2";
  style.textContent = [
...
/* Keep supporting frames distinct from the selected lead frame. */
(function () {
  "use strict";
